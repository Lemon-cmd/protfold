...
class ProteinTest(parameterized.TestCase):
    ...
    @parameterized.named_parameters(
        dict(testcase_name='chain_A',
             pdb_file=TEST_FILE, chain_id='A', num_res=282, num_chains=1),
        dict(testcase_name='chain_B',
             pdb_file=TEST_FILE, chain_id='B', num_res=282, num_chains=1),
        dict(testcase_name='multichain',
             pdb_file=TEST_FILE, chain_id=None, num_res=564, num_chains=2))
